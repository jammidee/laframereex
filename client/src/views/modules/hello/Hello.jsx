 ...
 * CREATED DATE : July 04, 2026 03:01 PM
 * ------------------------------------------------------------------------
 * DESCRIPTION  : About page and represents how to create page in a single 
 * folder.
 * ------------------------------------------------------------------------
 */
                        ...
                        <div className="row mb-2">
                            ...
                            <div className="col-sm-6">
                                <ol className="breadcrumb float-sm-right d-flex justify-content-sm-end list-inline">
                                    ...
                                    <li className="breadcrumb-item active list-inline-item">Hello</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="col-12">
                                <div className="card">
                                    <div className="card-body">
                                        Welcome to Lalulla Secure Hub. Authenticated Session Validated. Hello page.
                                    </div>
                                </div>
                            </div>
                        </div>
